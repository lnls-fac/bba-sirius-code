...
function BBAresult = BBAscan_sextder(ring,family_data,ind,bpm,corr,dir,is_skew,kickMax,range,DeltaK,random_error,is_sextupole)
    ...
    for n = -range:range
        ...
        ringTemp = lnls_set_kickangle(setRingDelta_sextder(ring,ind,0,is_skew,is_sextupole), lnls_get_kickangle(ring,corr,dir) + n*step_kick, corr, dir);
        ringDeltaTemp = lnls_set_kickangle(setRingDelta_sextder(ring,ind,DeltaK,is_skew,is_sextupole), lnls_get_kickangle(ringDelta,corr,dir) + n*step_kick, corr, dir);
