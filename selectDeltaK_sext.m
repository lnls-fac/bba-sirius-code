function DeltaK = selectDeltaK_sext(ring,family_data,twi,ind,dir,is_sextupole)
    pot = 1e6;
    ...
    if(is_sextupole)
        DeltaK = (50*50/pot)/(ang_kick*cte);
    else
        DeltaK = (50/pot)/(ang_kick*cte);
    end
    %Definimos DeltaK para termos um desvio médio de
